...
<?php }?>
<h2 style="text-align: center; margin-top: 5%;">Ivy Dining & Co </h2>
<img  class="logo" src="ivyimg/logo.jpeg" alt="mingle logo">
<div class="container-fluid" id="first-section">
    ...
    <div class="container-fluid" id="food-section">
        <h2 style="margin-left: 10%;" class="categories-heading">Main Course</h2>
                <div class="food-cards">
                    
                        <img class="img-fluid" id="sides" src="ivyimg/steak.jpg" alt="clickable image">
                        <p style="text-align: center;">Chicken Steak</p>
      ...
      <div class="modal-footer">
        ...
        <a href="purchase5k.php"><button type="button" class="btn btn-primary">Place Order</button></a>
                ...
                <div class="food-cards">
                        ...
                        <img class="img-fluid" id="sides" src="ivyimg/butter.jpeg" alt="clickable image">
                        <p style="text-align: center;">Butter Chicken</p>
                        <button style="margin: -5% 0 20% 10%;" class="btn btn-outline-light" id="orderBtn" data-bs-toggle="modal" data-bs-target="#orderModal">Order</button>
      ...
      <div class="modal-footer">
        ...
        <a href="purchase5k.php"><button type="button" class="btn btn-primary">Place Order</button></a>
                ...
                <div class="food-cards">
                        ...
                        <img class="img-fluid" id="sides" src="2in1img/2in1Pizza.jpg" alt="clickable image">
                        <p style="text-align: center;">Margherita</p>
                        <button style="margin: -5% 0 20% 10%;" class="btn btn-outline-light" id="orderBtn" data-bs-toggle="modal" data-bs-target="#orderModal">Order</button>
      ...
      <div class="modal-footer">
        ...
        <a href="purchase5k.php"><button type="button" class="btn btn-primary">Place Order</button></a>
                ...
                <div class="food-cards">
                        ...
                        <p style="text-align: center;">Vegetable Pizza</p>
                        <button style="margin: -5% 0 20% 10%;" class="btn btn-outline-light" id="orderBtn" data-bs-toggle="modal" data-bs-target="#orderModal">Order</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="purchase5k.php"><button type="button" class="btn btn-primary">Place Order</button></a>
                ...
                <h2 style="margin-left: 10%;" class="categories-heading">Appetizer</h2>
                <div class="food-cards">
                    
                        <img class="img-fluid " id="sides"  src="ivyimg/shrimp.jpg" alt="clickable Img">
                        <p style="text-align: center;">Dynamite Shrimp</p>
                        <button style="margin: -5% 0 20% 10%;" class="btn btn-outline-light" id="orderBtn" data-bs-toggle="modal" data-bs-target="#orderModal">Order</button>
      ...
      <div class="modal-footer">
        ...
        <a href="purchase5k.php"><button type="button" class="btn btn-primary">Place Order</button></a>
                ...
                <div class="food-cards">
                        ...
                        <img class="img-fluid " id="sides" src="ivyimg/loaded.jpg" alt="clickable Img">
                        <p style="text-align: center;">Loaded Fries</p>
                        <button style="margin: -5% 0 20% 10%;" class="btn btn-outline-light" id="orderBtn" data-bs-toggle="modal" data-bs-target="#orderModal">Order</button>
