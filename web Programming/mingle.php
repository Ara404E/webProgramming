...
<?php }?>
<h2 style="text-align: center; margin-top: 5%;">Mingle</h2>
<img  class="logo" src="images/minglee.png" alt="mingle logo">
    ...
    <div class="container-fluid" id="food-section">
        <h2 style="margin-left: 10%;" class="categories-heading">Main Course</h2>
                <div class="food-cards">
                        ...
                        <img class="img-fluid" id="sides" src="mingleimg/Cream.png" alt="clickable image">
                        <p style="text-align: center;">Chicken La Creama</p>
      ...
      <div class="modal-footer">
        ...
        <a href="purchase5k.php"><button type="button" class="btn btn-primary">Place Order</button></a>
                ...
                <div class="food-cards">
                        ...
                        <img class="img-fluid" src="mingleimg/SizzlingChicken.jpg" alt="clickable image">
                        <p style="text-align: center;">Sizzsling Chicken</p>
                        <button style="margin: -5% 0 20% 10%;" class="btn btn-outline-light" id="orderBtn" data-bs-toggle="modal" data-bs-target="#orderModal">Order</button>
      ...
      <div class="modal-footer">
        ...
        <a href="purchase5k.php"><button type="button" class="btn btn-primary">Place Order</button></a>
                ...
                <div class="food-cards">
                        ...
                        <img class="img-fluid " id="sides"  src="mingleimg/poutine.jpg" alt="clickable Img">
                        <p style="text-align: center;">Canadian Poutine</p>
                        <button style="margin: -5% 0 20% 10%;" class="btn btn-outline-light" id="orderBtn" data-bs-toggle="modal" data-bs-target="#orderModal">Order</button>
      ...
      <div class="modal-footer">
        ...
        <a href="purchase5k.php"><button type="button" class="btn btn-primary">Place Order</button></a>
                ...
                <div class="food-cards">
                        ...
                        <img class="img-fluid " id="sides" src="mingleimg/mega.jpg" alt="clickable Img">
                        <p style="text-align: center;">Mega Chees Fries</p>
                        <button style="margin: -5% 0 20% 10%;" class="btn btn-outline-light" id="orderBtn" data-bs-toggle="modal" data-bs-target="#orderModal">Order</button>
