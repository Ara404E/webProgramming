...
<head>
   ...
   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css">
    ...
    <title>Roma Resturant & Café</title>
</head>
<body>
<?php 
include("db.php");
...
<?php }?>
<h2 style="text-align: center; margin-top: 5%;">Roma Resturant & Café</h2>
<img  class="logo" src="images/roma.jpg" alt="Roma Resturant & Café logo">
<div class="container-fluid" id="first-section">
    ...
    <div class="container-fluid" id="food-section">
        ...
        <section class="end-section" id="contact"> 
            ...
            <p class="made">Made with ❤ by Ara Ali and Dere Rzgar and Dere Rzgar</p>
</body>
</html>